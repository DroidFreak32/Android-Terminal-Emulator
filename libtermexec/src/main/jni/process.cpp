...
Java_com_offsec_nhterm_TermExec_waitFor(JNIEnv *env, jclass clazz, jint procId) {
    int status;
...
JNIEXPORT jint JNICALL
Java_com_offsec_nhterm_TermExec_createSubprocessInternal(JNIEnv *env, jclass clazz,
